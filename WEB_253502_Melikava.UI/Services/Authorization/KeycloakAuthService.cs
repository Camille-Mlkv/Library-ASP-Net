...
namespace WEB_253502_Melikava.UI.Services.Authorization
{
    public class KeycloakAuthService : IAuthService
    {
        ...
        public KeycloakAuthService(HttpClient httpClient, IFileService fileService, ITokenAccessor tokenAccessor, IOptions<KeycloakData> options)
        {
